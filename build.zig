...
pub fn build(b: *std.Build) void {
    ...
    // const mod = b.addModule("bevy3Danimation", .{
    ...
    //         // root module.
    //         .imports = &.{
    //             // Here "bevy3Danimation" is the name you will use in your source code to
    //             // import this module (e.g. `@import("bevy3Danimation")`). The name is
    //             // repeated because you are allowed to rename your imports, which
    //             // can be extremely useful in case of collisions (which can happen
    //             // importing modules from different packages).
    //             .{ .name = "bevy3Danimation", .module = mod },
    //         },
    //     }),
    // });
    ...
    // 3. 把 zphysics 导入到这个 Module 中
    lib_mod.addImport("zphysics", zphysics.module("root"));

    // 4. 使用统一的 addLibrary 函数，并明确声明 linkage 为 .static (静态库)
    ...
    lib.root_module.linkSystemLibrary("c++", .{});
    // 6. 导出最终成果到 zig-out/lib/
    b.installArtifact(lib);
    // ✅ 新增：逼 Zig 把底层的 joltc 物理引擎本体也导出到 zig-out/lib/ 里！
